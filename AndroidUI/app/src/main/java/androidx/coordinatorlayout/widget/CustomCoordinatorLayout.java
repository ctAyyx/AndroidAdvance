 ...
 */
public class CustomCoordinatorLayout extends ViewGroup implements NestedScrollingParent2,
        NestedScrollingParent3 {
    static final String TAG = "CoordinatorLayout";
    static final String WIDGET_PACKAGE_NAME;

    static {
        final Package pkg = CustomCoordinatorLayout.class.getPackage();
    ...
    private final MyDirectedAcyclicGraph<View> mChildDag = new MyDirectedAcyclicGraph<>();
...
//        }
    ...
    private void log(String tag, String msg, boolean printLog) {
        if (DEBUG && printLog)
            Log.e(tag, msg);
    }
    ...
    private boolean performIntercept(MotionEvent ev, final int type) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            log("performIntercept i:" + i + " " + " child:" + child.getClass().getSimpleName());
            final LayoutParams lp = (LayoutParams) child.getLayoutParams();
            final Behavior b = lp.getBehavior();
    ...
    private void prepareChildren() {
        ...
        mChildDag.clear();
        log("prepareChildren start");
        // 通过遍历 找出添加了behavior的ChildView (view)和 该ChildView依赖的View(dependency)
        // 最后将这些view 和 dependency 添加到 mChildDag 中
        // 最后以 dependency 为Key组成有向无环图
        for (int i = 0, count = getChildCount(); i < count; i++) {
            ...
            for (int j = 0; j < count; j++) {
                ...
                log("prepareChildren===>>>i:" + i + "j:" + j + "View: " + view.getClass().getSimpleName() + " other:" + other.getClass().getSimpleName());
        ...
        // Finally add the sorted g|raph list to our list


        // 获取经过排列的集合
        // v-v-v-d-v-v-d
        ArrayList<View> result = mChildDag.getSortedList();
        for (int i = 0; i < result.size(); i++) {
            log("mChildDag.getSortedList===>" + result.get(i).getClass().getSimpleName());
        }

        mDependencySortedChildren.addAll(result);
        ...
        // 最终 dependencyView会在 behaviorView的前面
        for (int i = 0; i < mDependencySortedChildren.size(); i++) {
            log("mDependencySortedChildren===>" + mDependencySortedChildren.get(i).getClass().getSimpleName());
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        log("Behavior01", "onMeasure" + getParent());
        prepareChildren();
    ...
    final void onChildViewsChanged(@DispatchChangeEvent final int type) {
        log("onChildViewsChanged  Type:" + type);
        final int layoutDirection = ViewCompat.getLayoutDirection(this);
        final int childCount = mDependencySortedChildren.size();
     ...
     * {@link Behavior#onDependentViewChanged(CustomCoordinatorLayout, View, View)} to the associated
    ...
    void ensurePreDrawListener() {
        ...
        if (hasDependencies != mNeedsPreDrawListener) {
            if (hasDependencies) {
                log("addPreDrawListener");
                addPreDrawListener();
            } else {
                log("removePreDrawListener");
     ...
     * {@link CustomCoordinatorLayout} in the view hierarchy.
     *
     ...
     * when used as a direct child of an {@link CustomCoordinatorLayout}. The default behavior
    ...
    /**
     * Interaction behavior plugin for child views of {@link CustomCoordinatorLayout}.
     *
    ...
    public static abstract class Behavior<V extends View> {
         ...
         */
        public void onAttachedToLayoutParams(@NonNull CustomCoordinatorLayout.LayoutParams params) {
        }
         ...
         */
        public boolean onInterceptTouchEvent(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
         ...
         */
        public boolean onTouchEvent(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
                                    @NonNull MotionEvent ev) {
            return false;
        }
         ...
         * {@link Color#BLACK}.
         * @see #getScrimOpacity(CustomCoordinatorLayout, View)
         */
        @ColorInt
        public int getScrimColor(@NonNull CustomCoordinatorLayout parent, @NonNull V child) {
            return Color.BLACK;
        }
        ...
        public float getScrimOpacity(@NonNull CustomCoordinatorLayout parent, @NonNull V child) {
            return 0.f;
        }
         ...
         * {@link #getScrimOpacity(CustomCoordinatorLayout, View)} would return > 0.0f.</p>
         *
         * @param parent the parent view of the given child
         * @param child  the child view to test
         * @return true if {@link #getScrimOpacity(CustomCoordinatorLayout, View)} would
         * return > 0.0f.
         */
        public boolean blocksInteractionBelow(@NonNull CustomCoordinatorLayout parent, @NonNull V child) {
         ...
         * false otherwise
         * @see #onDependentViewChanged(CustomCoordinatorLayout, View, View)
         */
        public boolean layoutDependsOn(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
         ...
         * {@link #layoutDependsOn(CustomCoordinatorLayout, View, View)} or
         * if {@code child} has set another view as it's anchor.</p>
         *
         * <p>Note that if a Behavior changes the layout of a child via this method, it should
         * also be able to reconstruct the correct position in
         * {@link #onLayoutChild(CustomCoordinatorLayout, View, int) onLayoutChild}.
         ...
         */
        public boolean onDependentViewChanged(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
                                              @NonNull View dependency) {
            return false;
        }
         ...
         */
        public void onDependentViewRemoved(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
                                           @NonNull View dependency) {
        }
         ...
         * {@link CustomCoordinatorLayout#onMeasureChild(View, int, int, int, int)
         ...
         */
        public boolean onMeasureChild(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
         ...
         * {@link CustomCoordinatorLayout#onLayoutChild(View, int)
         * parent.onLayoutChild}.</p>
         *
         * <p>If a Behavior implements
         * {@link #onDependentViewChanged(CustomCoordinatorLayout, View, View)}
         ...
         */
        public boolean onLayoutChild(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
                                     int layoutDirection) {
            return false;
        }
         ...
         * {@link #onStartNestedScroll(CustomCoordinatorLayout, View, View, View, int, int)}. This
         * method will still continue to be called if the type is {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
        public boolean onStartNestedScroll(@NonNull CustomCoordinatorLayout coordinatorLayout,
        ...
        /**
         * @deprecated You should now override
         * {@link #onNestedScrollAccepted(CustomCoordinatorLayout, View, View, View, int, int)}. This
         * method will still continue to be called if the type is {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
        public void onNestedScrollAccepted(@NonNull CustomCoordinatorLayout coordinatorLayout,
                                           @NonNull V child, @NonNull View directTargetChild, @NonNull View target,
                                           @ScrollAxis int axes) {
            // Do nothing
        }
        ...
        /**
         * @deprecated You should now override
         * {@link #onStopNestedScroll(CustomCoordinatorLayout, View, View, int)}. This method will still
         * continue to be called if the type is {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
        public void onStopNestedScroll(@NonNull CustomCoordinatorLayout coordinatorLayout,
        ...
        /**
         * @deprecated You should now override
         * {@link #onNestedScroll(CustomCoordinatorLayout, View, View, int, int, int, int, int, int[])}.
         ...
         */
        @Deprecated
        public void onNestedScroll(@NonNull CustomCoordinatorLayout coordinatorLayout, @NonNull V child,
        ...
        /**
         * @deprecated You should now override
         * {@link #onNestedPreScroll(CustomCoordinatorLayout, View, View, int, int, int[], int)}.
         * This method will still continue to be called if the type is
         * {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
        public void onNestedPreScroll(@NonNull CustomCoordinatorLayout coordinatorLayout,
         ...
         */
        public boolean onNestedFling(@NonNull CustomCoordinatorLayout coordinatorLayout,
         ...
         */
        public boolean onNestedPreFling(@NonNull CustomCoordinatorLayout coordinatorLayout,
                                        @NonNull V child, @NonNull View target, float velocityX, float velocityY) {
            return false;
        }
         ...
         */
        @NonNull
        public WindowInsetsCompat onApplyWindowInsets(@NonNull CustomCoordinatorLayout coordinatorLayout,
         ...
         */
        public boolean onRequestChildRectangleOnScreen(@NonNull CustomCoordinatorLayout coordinatorLayout,
         ...
         */
        public void onRestoreInstanceState(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
         ...
         *
         * <p>Behavior state is only saved when both the parent {@link CustomCoordinatorLayout} and
         ...
         */
        @Nullable
        public Parcelable onSaveInstanceState(@NonNull CustomCoordinatorLayout parent, @NonNull V child) {
         ...
         */
        public boolean getInsetDodgeRect(@NonNull CustomCoordinatorLayout parent, @NonNull V child,
                                         @NonNull Rect rect) {
            return false;
        }
    }
    ...
    /**
     * Parameters describing the desired layout for a child of a {@link CustomCoordinatorLayout}.
     */
    public static class LayoutParams extends MarginLayoutParams {
         ...
         *
         * @see #isBlockingInteractionBelow(CustomCoordinatorLayout, View)
         */
         ...
         */
        @SuppressWarnings("unchecked")
        boolean isBlockingInteractionBelow(CustomCoordinatorLayout parent, View child) {
         ...
         */
        @SuppressWarnings("unchecked")
        boolean dependsOn(CustomCoordinatorLayout parent, View child, View dependency) {
         ...
         * {@link #findAnchorView(CustomCoordinatorLayout, View) found} before
         * being used again.
         */
         ...
         * {@link View#NO_ID}.
         */
        View findAnchorView(CustomCoordinatorLayout parent, View forChild) {
         ...
         */
        private void resolveAnchorView(final View forChild, final CustomCoordinatorLayout parent) {
         ...
         */
        private boolean verifyAnchorView(View forChild, CustomCoordinatorLayout parent) {

            ...
            public void subscribe(@NonNull ObservableEmitter<String> emitter) throws Throwable {
                ...
                .doOnSubscribe(new Consumer<Disposable>() {
                    ...
                    public void accept(Disposable disposable) throws Throwable {
                        ...
                        CLog.e("doOnSubscribe操作符");
                    }
                })
                .doOnNext(new Consumer<String>() {
                    @Override
                    public void accept(String s) throws Throwable {
                        CLog.e("doOnNext操作符:" + s);
                    }
                })
                .doAfterNext(new Consumer<String>() {
                    @Override
                    public void accept(String s) throws Throwable {
                        CLog.e("doAfterNext操作符:" + s);
                    }
                })
                .doOnError(new Consumer<Throwable>() {
                    @Override
                    public void accept(Throwable throwable) throws Throwable {
                        CLog.e("doOnError操作符:" + throwable.getMessage());
                    }
                })
                .doOnComplete(new Action() {
                    @Override
                    public void run() throws Throwable {
                        CLog.e("doOnComplete操作符");
                    }
                })
                .doOnEach(new Consumer<Notification<String>>() {
                    @Override
                    public void accept(Notification<String> stringNotification) throws Throwable {
                        CLog.e("doOnEach操作符:" + stringNotification.getValue());
                    }
                })
